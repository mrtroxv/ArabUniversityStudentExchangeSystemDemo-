...
const ContactInformation = ({ stepper, data }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    passportNumber: Yup.string().required("No passport number  provided"),
    passportExpiryDate: Yup.date().required("No Date provided")
  })
        ...
        {({ errors, touched, setFieldValue }) => (
          <Form>
            <Row>
              ...
              <Col md="6" className="mb-1">
                <label htmlFor="phone" className="form-label form-label">
                  {t("phone")}
                </label>
                <Field
                  type="text"
