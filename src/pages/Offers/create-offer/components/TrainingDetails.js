...
const TrainingDetails = ({ stepper, onSubmit, data }) => {
  ...
  const Schema = Yup.object().shape({
    ...
    train_length: Yup.number()
      .required("No Length provided")
      .min(4, "Too Short - Length must be at least 4 Weeks"),
    train_start_date: Yup.date().required("No Date provided"),
    train_end_date: Yup.date().required("No Date provided"),
    support_amount: Yup.number()
      .required("No Length provided")
      .min(4, "Too Short - Length must be at least 4 Weeks"),
    support_type: Yup.array().oneOf(
      supportTypeOptions.map((value) => value.value)
    )
  })
              ...
              <Col className="mb-1">
                ...
                <Field
                  ...
                  className={`form-control ${
                    errors.train_description && touched.train_description
                      ? "is-invalid"
                      : ""
                  }`}
                />
              ...
              <Col md="6" className="mb-1">
                ...
                <Select
                  ...
                  className={`react-select ${
                    errors.train_type && touched.train_type ? "is-invalid" : ""
                  }`}
                  classNamePrefix="select"
                  onChange={(option) => {
                    setFieldValue("train_type", option.value)
                  }}
                  defaultValue={trainingTypeOptions.find(
                    (option) => option.value === defaultValues.train_type
                  )}
                />
                <ErrorMessage
                  name="train_type"
            ...
            <Row>
              <Col md="6" className="mb-2">
                ...
                <Field
                  ...
                  className={`form-control ${
                    errors.train_length && touched.train_length
                      ? "is-invalid"
                      : ""
                  }`}
                />
              ...
              <Col md="3" className="mb-2">
                ...
                <Field
                  ...
                  className={`form-control ${
                    errors.train_start_date && touched.train_start_date
                      ? "is-invalid"
                      : ""
                  }`}
                />
              ...
              <Col md="3" className="mb-2">
                ...
                <Field
                  ...
                  placeholder="DD/MM/YYYY"
                  className={`form-control ${
                    errors.train_end_date && touched.train_end_date
                      ? "is-invalid"
                      : ""
                  }`}
                />
              ...
              <Col className="mb-1">
                ...
                <InputGroup className="input-group-merge mb-1">
                  ...
                  <Field
                    ...
                    placeholder="100"
                    className={`form-control ${
                      errors.support_amount && touched.support_amount
                        ? "is-invalid"
                        : ""
                    }`}
                  />
