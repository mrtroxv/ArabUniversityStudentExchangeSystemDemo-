...
const CompanyDetails = ({ stepper, onSubmit }) => {
    ...
    const Schema = Yup.object().shape({
        ...
        days_of_work: Yup.array().min(2, 'Please select at least two days').required('Please select at least two days'),

        inst_phone: Yup.string().matches(phoneRegExp, 'Phone number is not valid').required('No Phone Number provided'),

        inst_fax: Yup.string().matches(faxRegExp, 'Fax number is not valid').required('No fax Number provided'),

        weekly_hours: Yup.number().min(20, 'Please increase Weekly Hours').required('No weekly Hours provided'),

        daily_hours: Yup.number().min(5, 'Please increase Daily Hours').required('No Daily Hours provided')
    })
                    ...
                    <Form>
                        <Row>
                            <Col className='mb-1'>
                                ...
                                />
                                <ErrorMessage name="inst_name" component='p' className="invalid-feedback" />
                            ...
                            <Col>
                                ...
                                <Field
                                    ...
                                    className={`form-control ${errors.inst_address && touched.inst_address ? 'is-invalid' : ''}`}
                                />
                                <ErrorMessage name="inst_address" component='p' className="invalid-feedback" />
                            </Col>
                        </Row>
                        <Row>
                            <Col md='6' className='mb-1'>
                                ...
                                <Select
                                    ...
                                    className={`react-select ${errors.place_of_work && touched.place_of_work ? 'is-invalid' : ''}`}
                                    classNamePrefix='select'
                                    onChange={value => { values.place_of_work = value.value }}
                                />
                                <ErrorMessage name="place_of_work" component='p' className="invalid-feedback" />
                            ...
                            <Col md='6' className='mb-1'>
                                ...
                                />
                                <ErrorMessage name="train_aria" component='p' className="invalid-feedback" />
                        ...
                        <Row>
                            ...
                            <Col md='6' className='mb-1'>
                                ...
                                <Field
                                    ...
                                    className={`form-control ${errors.trainer_name && touched.trainer_name ? 'is-invalid' : ''}`}
                                />
                                <ErrorMessage name="trainer_name" component='p' className="invalid-feedback" />
                            ...
                            <Col md='6' className='mb-1'>
                                ...
                                <Select
                                    ...
                                    className={`react-select ${errors.days_of_work && touched.days_of_work ? 'is-invalid' : ''}`}
                                    classNamePrefix='select'
                                    onChange={value => { values.days_of_work = value.map(item => item.value) }}
                                />
                                <ErrorMessage name="days_of_work" component='p' className="invalid-feedback" />
                            </Col>
                        </Row>
                        <Row>
                            <Col md='6' className='mb-1'>
                                ...
                                />
                                <ErrorMessage name="inst_phone" component='p' className="invalid-feedback" />
                            ...
                            <Col md='6' className='mb-1'>
                                ...
                                />
                                <ErrorMessage name="inst_fax" component='p' className="invalid-feedback" />
                        ...
                        <Row>
                            ...
                            <Col md='6' className='mb-2'>
                                ...
                                <Field
                                    ...
                                    id={`weekly_hours`}
                                    placeholder='ex. 35'
                                    className={`form-control ${errors.weekly_hours && touched.weekly_hours ? 'is-invalid' : ''}`}
                                />
                                <ErrorMessage name="weekly_hours" component='p' className="invalid-feedback" />
                            ...
                            <Col md='6' className='mb-2'>
                                ...
                                <Field
                                    ...
                                    id={`daily_hours`}
                                    placeholder='ex. 5'
                                    className={`form-control ${errors.daily_hours && touched.daily_hours ? 'is-invalid' : ''}`}
                                />
                                <ErrorMessage name="daily_hours" component='p' className="invalid-feedback" />
